...
type DouyinFeedRequest struct {
	...
	LatestTime int64 `protobuf:"varint,1,opt,name=LatestTime,proto3" json:"latest_time" form:"lasest_time"` // 可选参数，限制返回视频的最新投稿时间戳，精确到秒，不填表示当前时间
	// @inject_tag: json:"token", form:"token"
	Token string `protobuf:"bytes,2,opt,name=Token,proto3" json:"token" form:"token"` // 可选参数，登录用户设置
}

func (x *DouyinFeedRequest) Reset() {
	*x = DouyinFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feedService_proto_msgTypes[0]
...
func (*DouyinFeedRequest) Descriptor() ([]byte, []int) {
	return file_feedService_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFeedResponse) Reset() {
	*x = DouyinFeedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feedService_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFeedResponse) Descriptor() ([]byte, []int) {
	return file_feedService_proto_rawDescGZIP(), []int{1}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feedService_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_feedService_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feedService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_feedService_proto_rawDescGZIP(), []int{3}
}
...
var File_feedService_proto protoreflect.FileDescriptor

var file_feedService_proto_rawDesc = []byte{
	0x0a, 0x11, 0x66, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x66, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x22, 0x49, 0x0a, 0x11, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65,
	...
	0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xa0, 0x01, 0x0a, 0x12,
	...
	,
	...
	0x66, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x6f, 0x75, 0x79,
	...
	0x5a, 0x0e, 0x2e, 0x2f, 0x3b, 0x66, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_feedService_proto_rawDescOnce sync.Once
	file_feedService_proto_rawDescData = file_feedService_proto_rawDesc
)

func file_feedService_proto_rawDescGZIP() []byte {
	file_feedService_proto_rawDescOnce.Do(func() {
		file_feedService_proto_rawDescData = protoimpl.X.CompressGZIP(file_feedService_proto_rawDescData)
	})
	return file_feedService_proto_rawDescData
}

var file_feedService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_feedService_proto_goTypes = []interface{}{
...
var file_feedService_proto_depIdxs = []int32{
	2, // 0: feedService.DouyinFeedResponse.VideoList:type_name -> feedService.Video
...
func init() { file_feedService_proto_init() }
func file_feedService_proto_init() {
	if File_feedService_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_feedService_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_feedService_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_feedService_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_feedService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_feedService_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_feedService_proto_goTypes,
		DependencyIndexes: file_feedService_proto_depIdxs,
		MessageInfos:      file_feedService_proto_msgTypes,
	}.Build()
	File_feedService_proto = out.File
	file_feedService_proto_rawDesc = nil
	file_feedService_proto_goTypes = nil
	file_feedService_proto_depIdxs = nil
}
