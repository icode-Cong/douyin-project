...
type MessageService interface {
	...
	LatestMessages(ctx context.Context, in *DouyinLatestMessagesRequest, opts ...client.CallOption) (*DouyinLatestMessagesResponse, error)
}
...
func (c *messageService) LatestMessages(ctx context.Context, in *DouyinLatestMessagesRequest, opts ...client.CallOption) (*DouyinLatestMessagesResponse, error) {
	req := c.c.NewRequest(c.name, "MessageService.LatestMessages", in)
	out := new(DouyinLatestMessagesResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type MessageServiceHandler interface {
	...
	LatestMessages(context.Context, *DouyinLatestMessagesRequest, *DouyinLatestMessagesResponse) error
}
...
func RegisterMessageServiceHandler(s server.Server, hdlr MessageServiceHandler, opts ...server.HandlerOption) error {
	type messageService interface {
		...
		LatestMessages(ctx context.Context, in *DouyinLatestMessagesRequest, out *DouyinLatestMessagesResponse) error
	}
	type MessageService struct {
		messageService
	}
...
func (h *messageServiceHandler) LatestMessages(ctx context.Context, in *DouyinLatestMessagesRequest, out *DouyinLatestMessagesResponse) error {
	return h.MessageServiceHandler.LatestMessages(ctx, in, out)
}
