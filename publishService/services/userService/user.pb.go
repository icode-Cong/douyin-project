...
type DouyinUserRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=UserId,proto3" json:"uid" form:"uid"` //用户id
	// @inject_tag: json:"utoken", form:"utoken"
	Token string `protobuf:"bytes,2,opt,name=Token,proto3" json:"utoken" form:"utoken"` //用户鉴权token
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0xda, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x75, 0x6e, 0x74, 0x22, 0x53, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65,
	...
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x1a, 0x44, 0x6f, 0x75,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14, 0x0a,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x85, 0x01, 0x0a, 0x17, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x41, 0x0a,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0e, 0x5a, 0x0c, 0x2e, 0x2e, 0x2f, 0x3b, 0x73, 0x65, 0x72, 0x76,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*DouyinUserRegisterRequest)(nil),  // 1: services.DouyinUserRegisterRequest
	(*DouyinUserRegisterResponse)(nil), // 2: services.DouyinUserRegisterResponse
	(*DouyinUserLoginRequest)(nil),     // 3: services.DouyinUserLoginRequest
	(*DouyinUserLoginResponse)(nil),    // 4: services.DouyinUserLoginResponse
	(*DouyinUserRequest)(nil),          // 5: services.DouyinUserRequest
	(*DouyinUserResponse)(nil),         // 6: services.DouyinUserResponse
}
var file_user_proto_depIdxs = []int32{
	0, // 0: services.DouyinUserResponse.User:type_name -> services.User
	3, // 1: services.UserService.Login:input_type -> services.DouyinUserLoginRequest
	1, // 2: services.UserService.Register:input_type -> services.DouyinUserRegisterRequest
	5, // 3: services.UserService.UserInfo:input_type -> services.DouyinUserRequest
	4, // 4: services.UserService.Login:output_type -> services.DouyinUserLoginResponse
	2, // 5: services.UserService.Register:output_type -> services.DouyinUserRegisterResponse
